...
void CNome3DView::RenderRay(tc::Ray& ray, QVector3D intersection) {
    ...
    // TODO: the camera position stays constant, so seems like we have to rotateRay here. This seems a bit counterintuitive. camera should be moving, not the entire scene
    //rotateRay(ray);
    ...
    tc::Vector3 rotated_intersection = tc::Vector3(Q_rotated_intersection.x(), Q_rotated_intersection.y(),
                                       Q_rotated_intersection.z());
