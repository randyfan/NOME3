...
namespace NomeFace // Randy changed this also
{
...
class CFaceToQGeometry
{
public:
    explicit CFaceToQGeometry(const CMeshImpl& fromMesh, const CMeshImpl::FaceHandle& fH,
                              bool bGenPointGeometry);

    ~CFaceToQGeometry();

    CFaceToQGeometry(const CFaceToQGeometry&) = delete;
    CFaceToQGeometry(CFaceToQGeometry&&) = delete;
    CFaceToQGeometry& operator=(const CFaceToQGeometry&) = delete;
    CFaceToQGeometry& operator=(CFaceToQGeometry&&) = delete;
